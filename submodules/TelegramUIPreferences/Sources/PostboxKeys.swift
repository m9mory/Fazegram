...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let fazeGramSettings: EngineDataBuffer = applicationSpecificPreferencesKey(ApplicationSpecificSharedDataKeyValues.fazeGramSettings.rawValue)
}
